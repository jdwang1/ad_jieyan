var acc_host='accwww34.53kf.com';var companyid='70867121';var hz6d_guest_ip='122.13.132.172';var ipstr='%E5%B9%BF%E4%B8%9C%E7%9C%81%E5%B9%BF%E5%B7%9E%E5%B8%82%5B%E8%81%94%E9%80%9A%5D';var areastr='%E5%B9%BF%E4%B8%9C%2D%E5%B9%BF%E5%B7%9E';var ipContinent='%E4%BA%9A%E6%B4%B2';var in_timestamp='1538229248052';var hz6d_guest_id='10914176697012';var hz6d_style_id= '1';var hz6d_alias_host='http://www34.53kf.com';var company_site={};var mnone=0;var hz6d_device='';
/* 
    变量：
...
$53.data("workers",{"5621556":{"worker_id":"011","bname":"在线客服1","state":1},"10077244":{"worker_id":"52008820@qq.com","bname":"","state":0},"5621941":{"worker_id":"022","bname":"在线客服2","state":0},"5612504":{"worker_id":"00","bname":"全经理","state":0}});$53.data("groups",{"84504":{"group_name":"客服部","workers":["5621556","5621941"]},"150404":{"group_name":"投诉建议","workers":["5612504"]}});$53.data("shunt_info",{"shunt_type":"1"});$53.data("area_shunt",{});$53.data("source_shunt",{});$53.data("channel_shunt",{});$53.data("over_flow",{});$53.data("over_flow_schedule",{});$53.data("of_all_worker",{"5621556":{"worker_id":"011","bname":"在线客服1","state":1},"10077244":{"worker_id":"52008820@qq.com","bname":"","state":0},"5621941":{"worker_id":"022","bname":"在线客服2","state":0},"5612504":{"worker_id":"00","bname":"全经理","state":0}});$53.data("of_groups",{"84504":{"group_name":"客服部","workers":["5621556","5621941"]},"150404":{"group_name":"投诉建议","workers":["5612504"]}});$53.data("mobileCompanyInfo",{"mobile_music":"","company_logo":"","company_short":"","zdyurl":"","company_intr":""});$53.data("icon_award",{});
$53.data("is_update",0);
(function(window,undefined){
    var head=document.getElementsByTagName("head")[0];
    var kfscript1= document.createElement("script");
    kfscript1.src="http://www34.53kf.com/custom/70867121/mobile_icon_70867121_1.js?v=1490261971";
    var done1=false;
    ...
    kfscript2.src="http://www34.53kf.com/custom/70867121/mobile_invite_70867121_1.js?v=1490863135";
    var done2=false;
    ...
    kfscript3.src="http://www34.53kf.com/custom/70867121/assign_worker_70867121_1.js?v=1495370640";
    var done3=false;
    ...
    kfscript4.src="http://www34.53kf.com/js/default/mobile_chat_default.js?v=2017080212";
    var done4=false;
	...
	*/
	...
	_53_mobile_chat.prototype.createChat = function(){
		...
		if (_this.mobile_config["mobile_music"] != "" && _this.audio != null && _this.audio.canPlayType && _this.audio.canPlayType("audio/mpeg") && _this.isOnline) {
			_this.audio.src = _this.talkHost+"/mobile_new/sound/"+_this.mobile_config["mobile_music"]+".mp3";
	...
	_53_mobile_chat.prototype.createMinChat = function(is_uc,is_ios,type){
		...
		if((_this.is_open == 1 && _this.open_sdk == 0) || type != undefined){
			if(_this.chat_window == 1 ) _this.kf_openurl = _this.getOpenUrl() + _this.params + '&minchat=1#' + location.href;
			else  _this.kf_openurl = _this.getOpenUrl() + _this.params + '&is_minchat=1#' + location.href;
	...
	_53_mobile_chat.prototype.talk = function(params){
		var _this = this;
	...
	_53_mobile_chat.prototype.openSdkUrl = function(){
		var _this = this;
		var is_uc = 0;
		var is_ios = !!navigator.userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);
		if (is_ios && navigator.userAgent.indexOf("UCBrowser") != -1) {
	...
	_53_mobile_chat.prototype.showMsgCard = function(str){
		...
		if(card == null || card == undefined){
			$53.creElm({
				...
				'innerHTML':'<div onclick="show_mobile_chat();"><span class="message-card-head" style="display:block;width: 100%;height:2.6em;position: relative;">'+worker_img+'<span style="color: '+_this.chat_content_color+';width:12.86em;overflow: hidden;text-overflow:ellipsis;white-space:nowrap;letter-spacing: 0.6px;line-height: 1.43em;position: absolute;left: 2.29em;bottom:0.15em;font-size: 1.4em">'+worker_name+'</span><span style="width: 2.8em;height: 2.8em;position: absolute;right: 0;top: 0;"><span style="position: absolute;right:0;top:0;width: 1.6em;height: 1.6em;opacity: 0.7;filter: alpha(opacity=70);" onclick="hide_chat_card(e)"><svg style="float:left" height="100%" viewBox="0 0 16.5 16.5" width="100%" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="m8 0c4.418278 0 8 3.581722 8 8 0 4.418278-3.581722 8-8 8-4.418278 0-8-3.581722-8-8 0-4.418278 3.581722-8 8-8z" fill="#363d4d" opacity=".6"></path><path d="m12.25 4.808-1.057-1.058-3.193 3.192-3.192-3.192-1.058 1.058 3.192 3.192-3.192 3.193 1.058 1.057 3.192-3.193 3.193 3.193 1.057-1.057-3.193-3.193z" fill="#fff"></path></g></svg></span></span></span><span class="message-card-body" style="display:block;height:4.4em;width: 100%;position: relative;"><p class="card-content" style="display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 2;overflow: hidden;color: '+_this.chat_content_color+';letter-spacing: 0.6px;line-height: 1.5em;margin-top:0.5em;font-size: 1.2em" id="mobile_chat_talk_str">'+str+'</p></span></div>'
			},'div');
...
var head=document.getElementsByTagName("head")[0];var script=document.createElement("script");script.src="http://www34.53kf.com/kf_new.php?arg=9004876&style=1&land_page="+hz6d_land_page+"&from_page="+$53.EN(hz6d_from_page)+"&kf_sign=DIyOTMTUzOI0ODEwOTE0MTc2Njk3MDEy&ip_long=2047706284";var done=false;script.onload=script.onreadystatechange=function(){if(!done&&(!this.readyState||this.readyState=="loaded"||this.readyState=="complete")){done=true;script.onload=script.onreadystatechange=null;head.removeChild(script);}};head.appendChild(script);
